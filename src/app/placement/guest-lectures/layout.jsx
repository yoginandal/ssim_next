export async function generateMetadata({ params }) {
  return {
    ...
    description: "Explore guest lectures and industry expert sessions at Siva Sivani Institute of Management (SSIM).",
    keywords: "SSIM guest lectures, industry experts, corporate sessions, business leaders",
    openGraph: {
      title: "Guest Lectures - SSIM",
      description: "Explore guest lectures and industry expert sessions at Siva Sivani Institute of Management (SSIM).",
